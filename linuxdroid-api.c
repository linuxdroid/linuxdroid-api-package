// linuxdroid-api.c - helper binary for calling linuxdroid api classes
// Usage: linuxdroid-api ${API_METHOD} ${ADDITIONAL_FLAGS}
//        This executes
//          am broadcast com.linuxdroid.api/.LinuxdroidApiReceiver --es socket_input ${INPUT_SOCKET} 
...
_Noreturn void exec_am_broadcast(int argc, char** argv, char* input_address_string, char* output_address_string)
{
    ...
    child_argv[3] = "0";
    child_argv[4] = "-n";
    child_argv[5] = "com.linuxdroid.api/.LinuxdroidApiReceiver";
    child_argv[6] = "--es";
    ...
    execv("/data/data/com.linuxdroid/files/usr/bin/am", child_argv);

    perror("execv(\"/data/data/com.linuxdroid/files/usr/bin/am\")");
    exit(1);
}
